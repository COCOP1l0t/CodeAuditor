...
The vulnerability report from PoC development (Stage 6) is at:
...
| "I already verified this in Stage 6, I'll skip verification" | Verify again. The minimal PoC must trigger independently. |
| "I'll just copy the Stage 6 report and clean it up" | Write a new report from scratch. Verify every claim. |
